...
<head>
    ...
    <link rel="stylesheet" href="gt.js">
        ...
        <div class="max-w-6xl m-auto grid md:grid-cols-3 gap-8">
            ...
            <div class="content-left md:col-span-2">
                <div class="bg-white drop-shadow-md rounded-md mb-4">
                    <!-- banner -->
                    <div><img class="w-full" src="img/Capture.PNG" alt=""></div>
                    <div class="md:px-12 px-4 py-6">
                        <div >
                            <!-- <div class=""><img class="fixed" src="img/qrcode_loship.vn.png" alt=""></div> -->
                        ...
                        <div class="grid md:grid-cols-2">
                            ...
                            <div class=" md:block hidden">
                                <p class="py-2"><i class="fa fa-link" aria-hidden="true"></i> https://loship.vn/trasuatencent <button class="bg-[#f6f6f6] text-xs float-right">copy link</button></p>
                    ...
                    <div class="md:col-span-3">
                        ...
                        <div class="p-3 bg-white rounded-md">
                            ...
                            <div class="flex justify-between my-8">
                                <div class="flex">
                                    <img class="w-36 rounded-md" src="img/trasua.png" alt="">
                                    <div class="px-2">
            ...
            <div class="content-right md:block hidden">
                <ul class="p-3 bg-white rounded-md mb-3 rounded-lg">
                    <li class="border-b py-2 font-bold"><h1>ƯU ĐÃI</h1></li>
                    <li class="border-b py-2"><p><i class="fa fa-map-marker"></i> Freeship đơn hàng dưới 2km</p></li>
                ...
                <div class="">
                    <div class="px-3 py-6 bg-white drop-shadow-md mb-3 rounded-lg">
                        <div class="flex justify-between border-b pb-2 text-[#9c9c9c]"><h1>ĐƠN HÀNG CỦA BẠN</h1> <button class="bg-[#0897ee] rounded-lg p-1 text-white font-semibold">Đặt nhóm</button></div>
                        <div class="text-center p-4"><p>Hãy chọn món yêu thích của bạn trên menu để đặt giao hàng ngay!</p></div>
                        <div class="flex justify-between font-semibold"><p>Tổng: <span class="text-[#9c9c9c]">(Tạm tính) <i class="fa fa-question-circle-o" aria-hidden="true"></i></span> </p> <span class="text-[#f7001e]">~ 0đ</span></div>
                    </div>
